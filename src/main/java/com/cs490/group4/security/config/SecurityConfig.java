...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(ENVIRONMENT_TYPE.equals("localhost") ? Arrays.asList("http://localhost:5173", "https://bryceblankinship.com") : Arrays.asList("https://bryceblankinship.com"));
